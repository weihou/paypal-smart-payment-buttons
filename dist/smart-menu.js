window.spb = function(modules) {
    ...
    var n, preact_module_u, preact_module_i, preact_module_t, preact_module_r, preact_module_o, e = {}, c = [], s = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord/i;
    function a(n, l) {
    ...
    function g(l) {
        (!l.__d && (l.__d = !0) && preact_module_u.push(l) && !preact_module_i++ || preact_module_r !== n.debounceRendering) && ((preact_module_r = n.debounceRendering) || preact_module_t)(_);
    }
    function _() {
    ...
    function $(n, l, u, i, t, r, o, f) {
        ...
        if (null === l.type) y !== d && n.data != d && (n.data = d); else {
            ...
            })(n, d, y, t, f), h ? l.__k = [] : (l.__k = l.props.children, b(n, l, u, i, "foreignObject" !== l.type && t, r, o, e, f)), 
    ...
    n.__r = function(n) {
        ...
        hooks_module_u.__H.__h.forEach(q), hooks_module_u.__H.__h = []);
    }, n.diffed = function(t) {
        hooks_module_f && hooks_module_f(t);
        var u = t.__c;
        if (u) {
            var i = u.__H;
            i && i.__h.length && (1 !== hooks_module_o.push(u) && hooks_module_r === n.requestAnimationFrame || ((hooks_module_r = n.requestAnimationFrame) || function(n) {
                var t, u = function() {
    ...
    function setupMenu(_ref3) {
        l = h(Page, {
            ...
            return body;
        }(), n.__ && n.__(l, u), r = (t = i === preact_module_o) ? null : u.__k, l = h(d, null, [ l ]), 
        f = [], A(u, u.__k = l, r || e, e, void 0 !== u.ownerSVGElement, r ? null : c.slice.call(u.childNodes), f, e, t), 
        T(f, l);
        var l, u, i, t, r, f;
    }
} ]);